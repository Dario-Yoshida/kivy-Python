...
class BannerVenda(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        esquerda_texto = Label(text=cliente, size_hint=(1, 0.2), pos_hint={"right": 1, "top": 0.2})
        ...
        meio_texto = Label(text=produto, size_hint=(1, 0.2), pos_hint={"right": 1, "top": 0.2})
        meio.add_widget(meio_imagem)
        meio.add_widget(meio_texto)


        direita = FloatLayout()
        direita_label_data = Label(text=f"{data}", size_hint=(1, 0.33), pos_hint={"right": 1, "top": 0.9})
